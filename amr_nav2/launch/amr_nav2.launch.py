...
def generate_launch_description():
    ...
    # directory to the source navigation stack pkg (ROS2 NAV2)
    bringup_dir = get_package_share_directory('nav2_bringup') 
    launch_dir = os.path.join(bringup_dir, 'launch')

    share_dir = get_package_share_directory('amr_nav2')
    ekf_pkg_path = os.path.join(share_dir, 'config/', 'ekf.yaml')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(share_dir, 'params', 'auto_slam_param.yaml'),
    ...
    declare_mapper_online_async_param_cmd = DeclareLaunchArgument(
        'async_param',
        default_value=os.path.join(share_dir, 'config', 'mapper_params_online_async.yaml'),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config',
        default_value=os.path.join(share_dir, 'rviz', 'nav2_default_view.rviz'),
    ...
    robot_localization_node = Node(
       ...
       output='screen',
       parameters=[ekf_pkg_path, {'use_sim_time': use_sim_time}]
)
    ...
    bringup_cmd_group = GroupAction([
        ...
        # NON-SLAM Localization launch with nav2
        IncludeLaunchDescription(

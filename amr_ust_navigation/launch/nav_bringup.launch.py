...
def generate_launch_description():
    ...
    nav2_dir = get_package_share_directory('amr_ust_navigation')
    ...
    robot_localization_node = Node(
       ...
       output='screen',
       parameters=[os.path.join(nav2_dir, 'config/ekf.yaml'), {'use_sim_time': LaunchConfiguration('use_sim_time')}] # {'use_sim_time': LaunchConfiguration('use_sim_time')}
    )

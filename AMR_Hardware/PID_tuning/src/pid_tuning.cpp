...
// ------------------------------------------
rcl_publisher_t flag_publisher;
// ------------------------------------------
...
// rclc return value checker for entity creation and destruction
void rclErrorLoop(){
    while(true){
...
bool destroy_entities(){
    ...
    RCSOFTCHECK(rcl_publisher_fini(&flag_publisher, &node));

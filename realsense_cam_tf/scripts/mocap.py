...
class RealsenseImu(Node):
    def __init__(self):
        ...
        # Create subscriptions for IMU and aligned depth topics
        self.gyro_sub = self.create_subscription(
            Imu,
            'camera/camera/gyro/sample',
            self.cam_gyro_callback,
            custom_qos
        )
    ...
    def cam_gyro_callback(self, msg):
        # Just logging angular velocity for now
        # self.get_logger().info(
        #     f"Gyro Data - Angular Velocity: x={msg.angular_velocity.x}, y={msg.angular_velocity.y}, z={msg.angular_velocity.z}"
        # )
        pass

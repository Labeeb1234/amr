...
- created similar to the standard template based bot config file for a custom bot of my own making (for now the bot is a 4WD with an imu, lidar sensor(no isaaclab implementation yet)). [source code]()
